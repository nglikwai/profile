...
const TitleRolling = () => {
  ...
  return (
    <h1 className="font-black text-6xl leading-snug xl:!w-full md:text-5xl sm:text-3xl w-[700px] min-h-[165px] md:min-h-[100px] sm:min-h-[60px] text-center tracking-wider sm:font-semibold">
